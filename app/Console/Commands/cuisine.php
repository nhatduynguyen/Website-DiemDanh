...
class cuisine extends Command
{
     ...
     * @var string
     */
    protected $signature = 'command:cuisine';
     ...
     * @var string
     */
    protected $description = 'Command cuisine';
    ...
    {
        try {
            $categoty_link = 'https://ifind.vn/api/v1/getCategoryDeal?cateId=1';
            $image_folder_path = 'uploads/cuisine/';
            $image_social_folder_path = 'uploads/social/cuisine/';
            $promotion_type = 'cuisine';
            $promotion_type_title = 'Ẩm thực';
