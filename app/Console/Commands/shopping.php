...
class shopping extends Command
{
     ...
     * @var string
     */
    protected $signature = 'command:shopping';
     ...
     * @var string
     */
    protected $description = 'Command shopping';
    ...
    {
        try {
            $categoty_link = 'https://ifind.vn/api/v1/getCategoryDeal?cateId=4';
            $image_folder_path = 'uploads/shopping/';
            $image_social_folder_path = 'uploads/social/shopping/';
            $promotion_type = 'shopping';
            $promotion_type_title = 'Mua sắm';
