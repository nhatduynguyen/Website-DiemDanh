...
<p>
	<a class="btn btn-dark far fa-arrow-alt-circle-left" style="font-size:20px" href="javascript:history.back()"> Về trang trước</a>
</p>
...
<div>
	<form class= "loginForm" action="{{ url('diemdanhlop/{id}/show/createstudent') }}" method="post">
        ...
        <div class="form-group">
			<i class="fas fa-id-card"></i>
			<label for="id_schedule">STT</label>
			<input type="text" style="font-size:18px" class="form-control" id="id_schedule" name="id_schedule" autofocus maxlength="10" required />
		</div>
